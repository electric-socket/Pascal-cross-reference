...
program imreg;
  ...
  Var
      ...
      totalLines,       //< total number of lines read
  ...
  begin
     ...
     Writeln('imref - Special build');
     writeln('Preparing to read all .pas. .pp, and .inc files in this ',
             'directory and all subdirectories');
     Writeln('for "first_mm_imreg" ');
     Writeln('Output sent to imreg.lst');
     writeln('Started: ',TimeStamp,', please wait...');
     Assign(Outfile,'imreg.lst');
     Rewrite(Outfile);
  ...
  begin   // .Main.
        ...
        writeln('Processed ',Comma(GlobalFileCount),' files in ',
                           Comma(dircount),' directories.');
        writeln('Total lines read was ',Comma(TotalLines),
             ' detected: ',Comma(FoundCount),' files with sentinel');
