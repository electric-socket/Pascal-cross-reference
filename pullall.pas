...
program pullall;
  ...
  begin
     ...
     Writeln('Pullall - Examine Pascal source files for ',
                      'compiler switches and conditionals');
     writeln('Preparing to read all .pas. .pp, and .inc files in ',
             'this directory and all subdirectories for');
     Writeln(' a block comment starting with $, e.g {$ ot (*$ .');
     Writeln('Output sent to Pullall.lst');
     writeln('Started: ',TimeStamp,', please wait...');
     Assign(Outfile,'pullall.lst');
     Rewrite(Outfile);
